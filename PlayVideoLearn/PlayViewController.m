...
//  MiYun360
//
//  Created by Gaojuan on 2017/5/10.
//  Copyright © 2017年 AUNotBad. All rights reserved.
//
...
- (void)viewDidLoad {
    ...
    self.title = @"视频";
    NSURL *url = [NSURL URLWithString:@"http://flv2.bn.netease.com/videolib3/1611/28/GbgsL3639/HD/movie_index.m3u8"];
...
//    layer的frame
    ...
    // 把Layer加到底部View上
    [self.backView.layer insertSublayer:_playerLayer atIndex:0];
    // 监听播放器状态变化
...
- (void)initUI{
    ...
    [self.topView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.top.equalTo(self.backView).with.offset(0);
    ...
    [self.bottomView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.left.right.equalTo(self.backView).with.offset(0);
        make.height.mas_equalTo(50);
    }];
